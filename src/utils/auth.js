          ...
          <div style="margin: 50px auto; width: 70%; padding: 20px 0">
            <div style="border-bottom: 4px solid #b3b3b3; text-align: center; margin: 0; padding: 0;">
              <a href="" style="
                ...
                padding: 0;
              ">
                <img src="https://res.cloudinary.com/dv2jeayrr/image/upload/v1717437197/jac1mqn85cwjyxcamadd.png" style="object-fit: cover; width: 125px; height: 125px; margin: 0 auto;" />
                <p style="
                  font-size: 1.4em;
                  color: #7224be;
                  font-weight: bold;
